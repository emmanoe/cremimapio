...
#define opt0 "--getinfo" //ok
#define opt1 "--getheight" //ok
#define opt2 "--getwidth" //ok
#define opt3 "--getobjects" //ok
#define opt4 "--setheight" //ok
#define opt5 "--setwidth" //OK
#define opt6 "--setobjects" //ok
#define opt7 "--pruneobjects" //ok
#define opt8 "--getpresence" //ok
